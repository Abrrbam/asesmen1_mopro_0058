...
import com.abrahamputra0058.asesment1.ui.model.Agenda
import com.abrahamputra0058.asesment1.ui.model.MainViewModel
...
fun MainScreen(navController: NavHostController){
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    navController.navigate(Screen.FormAdd.route)
                }
            ) {
                Icon(
